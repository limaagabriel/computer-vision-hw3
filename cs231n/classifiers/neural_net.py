...
class TwoLayerNet(object):
    ...
    def train(self, X, y, X_val, y_val,
        ...
        for it in range(num_iters):
            ...
            choices = np.random.choice(range(num_train), batch_size, replace=True)
            X_batch = X[choices]
            y_batch = y[choices]
    ...
    def predict(self, X):
        ...
        T = np.maximum(0, X.dot(self.params['W1']) + self.params['b1'])
        scores = T.dot(self.params['W2']) + self.params['b2']
